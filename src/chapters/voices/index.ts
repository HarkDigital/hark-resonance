...
// PLACEHOLDER — replaced by the voices chapter build.
export default function create(): Chapter {
  ...
  return {
    ...
    init(ctx) {
      ...
      el('p', 'hud-eyebrow', 'Liner Notes', ctx.stage).style.cssText = 'position:absolute;left:var(--gutter);top:var(--safe-top)'
      const h = el('h2', 'hud-h2', undefined, ctx.stage)
      h.innerHTML = 'We listen. <em>They talk.</em>'
