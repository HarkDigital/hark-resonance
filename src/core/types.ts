...
export interface ChapterContext {
  ...
  /**
   * Shared studio: backdrop dome (bone cyclorama ↔ graphite room) + a studio
   * environment map on scene.environment. Set studio.params each frame.
   */
  studio: Studio
  post: Post
  assets: Assets
 ...
 * pressure-wave ripple + paper wash in post. Keep the first and last ~4% of local
